<template>
  <div class="add-players">
    ...
    <VInput class="add-players__input" ref="input" v-model="currentValue" placeholder="Paste links of steam profiles..." :invalid="!isInputValid"
...
import {CLEAR_PLAYERS, GET_PLAYERS} from '@/store';
